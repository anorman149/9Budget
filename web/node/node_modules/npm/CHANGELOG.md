...
This is a quick patch to the release to fix an issue that was preventing applicationUsers
...
occasional fix, in the next few releases as more applicationUsers start playing with it and
...
release candidates on tags other than `latest` and applicationUsers won't see them
