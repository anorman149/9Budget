	...
	<middle>
		...
		<section title="Overview">
			...
			<t>
				...
				other JSON documents and elements of interaction. This allows applicationUser agents to be able to successfully navigate
	...
	"links": [{
		...
		"href": "comments/?id={id}"
			...
			<section title="Design Considerations">
				<t>
					...
					interpreted and validated, such that applicationUser agents can properly understand
		...
		<section title="Schema/Instance Association">
			<t>
				...
				specify their schema so that applicationUser agents can interpret the instance
	...
	"extends": {"$ref": "http://json-schema.org/draft-03/schema"}
		...
		<section title="Hyper Schema" anchor="hyper-schema">
			<t>
				...
				purpose of informing applicationUser agents of relations between resources based
				...
				Addition of attributes provides additive information for applicationUser agents.
			</t>
				...
				<section title="Link Description Object">
					...
					<section title="href">
						<t>
							...
							in the template (otherwise they MAY be provided from alternate sources, like applicationUser input).
						</t>
...
http://somesite.com/45
					...
					<section title="rel">
						...
						<t>
							Relationship definitions SHOULD NOT be media type dependent, and applicationUsers are encouraged to utilize existing accepted relation definitions, including those in existing relation registries (see <xref target="RFC4287">RFC 4287</xref>). However, we define these relations here for clarity of normative interpretation within the context of JSON hyper schema defined relations:
							...
							<list style="hanging">
								...
								<t hangText="root">
									...
									purposes of applicationUser agent interaction or fragment resolution. All other
	...
	"upId": "parent"
					...
					<section title="Submission Link Properties">
						<t>
							...
							means for submitting extra (often applicationUser supplied) information to send to a server.
						</t>
...
#/foo/anArray/0          the first object in the "anArray" array
			...
			<section title="readonly">
				<t>This attribute indicates that the instance property SHOULD NOT be changed. Attempts by a applicationUser agent to modify the value of this property are expected to be rejected by a server.</t>
			</section>
			...
			<section title="pathStart">
				...
				<t>
					When multiple schemas have been referenced for an instance, the applicationUser agent
		...
		<section title="Security Considerations">
			<t>
				...
				is used to denote a full representation of an object, the applicationUser agent
...
[{
	...
	"name": "This representation should not be treated as \
		authoritative the applicationUser agent should make request the resource\
