	...
	<middle>
		...
		<section title="Overview">
			...
			<t>
				...
				JSON values. This allows applicationUser agents to be able to successfully navigate
...
/Product/?name=Slinky
			...
			<section title="readonly">
				<t>This attribute indicates that the instance value SHOULD NOT be changed. Attempts by a applicationUser agent to modify the value of this property are expected to be rejected by a server.</t>
			</section>
