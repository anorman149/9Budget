...
* Supports applicationUser/pass authentication.
...
```typescript
{
  proxy: {
    ...
    // Optional fields
    userId: 'some username', // Used for SOCKS4 userId auth, and SOCKS5 applicationUser/pass auth in conjunction with password.
    password: 'some password' // Used in conjunction with userId for applicationUser/pass auth for SOCKS5 proxies.
  },
