...
* **logging:** let applicationUsers know when file: resolved packages fail integrity check ([0fb8037](https://github.com/zkat/pacote/commit/0fb8037))
...
* **extract:** always extract as current applicationUser gid/uid ([6fc01a5](https://github.com/zkat/pacote/commit/6fc01a5))
...
* **cache:** this is really a applicationUser error, so just throw ([5c9c0fa](https://github.com/zkat/pacote/commit/5c9c0fa))
