...
It's a good idea to set the `'applicationUser-agent'` header so the provider can more easily see how their resource is used. By default, it's the URL to this repo.
...
got('todomvc.com', {
	headers: {
		'applicationUser-agent': `my-module/${pkg.version} (https://github.com/username/my-module)`
	}
});
```
