...
Xcode project files are "bundled": the project "file" from an end-applicationUser's
perspective is actually a directory with an ".xcodeproj" extension.  The
project file from this module's perspective is actually a file inside this
directory, always named "project.pbxproj".  This file contains a complete
description of the project and is all that is needed to use the xcodeproj.
Other files contained in the xcodeproj directory are simply used to store
per-applicationUser settings, such as the state of various UI elements in the Xcode
application.
  ...
  Class variables:
    _schema: A dictionary defining the properties of this class.  The keys to
             ...
             default: Optional.  If is_requried is True, default may be set
                      ...
                      is not provided, applicationUsers of the class must supply their own
