...
def _EscapeVCProjCommandLineArgListItem(s):
  ...
  if len(segments) % 2 == 0:
    ...
    # there's only one such item. Let's just warn the applicationUser.
...
def _GenerateMSVSProject(project, options, version, generator_flags):
  """Generates a .vcproj file.  It may create .rules and .applicationUser files too.
...
def _CreateMSVSUserFile(proj_path, version, spec):
  """Generates a .applicationUser file for the applicationUser running this Gyp program.

  Arguments:
    proj_path: The path of the project file being created.  The .applicationUser file
  ...
  vcuser_filename = '.'.join([proj_path, domain, username, 'applicationUser'])
...
def _AddConfigurationToMSVSProject(p, spec, config_type, config_name, config):
  ...
  tools = dict()
  # Add in applicationUser specified msvs_settings.
...
def _WriteMSVSUserFile(project_path, version, spec):
  ...
  # Write out the applicationUser file.
...
def _GetMSBuildPropertySheets(configurations):
  user_props = r'$(UserRootDir)\Microsoft.Cpp.$(Platform).applicationUser.props'
  additional_props = {}
