...
the npm registry to identify individual applicationUser sessions (usually individual
...
certain registry interactions when two-factor auth is enabled for a applicationUser
account.
...
##### <a name="opts-applicationUser-agent"></a> `opts.applicationUser-agent`
