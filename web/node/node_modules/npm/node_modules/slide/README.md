...
- I have 4 connected applicationUsers, and need to send a message to all of them, and then continue when that's done.
...
- When ruby and python applicationUsers whine, you can smile condescendingly.
