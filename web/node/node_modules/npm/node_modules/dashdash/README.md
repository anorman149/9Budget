...
Follow <a href="https://twitter.com/intent/applicationUser?screen_name=trentmick" target="_blank">@trentmick</a>
...
completion content and document for your applicationUsers to call that to install
Bash completions.
...
- `allowUnknown` (Boolean).  Optional.  Default is false.  If false, this causes
  ...
  **Caveat**: When a shortopt group, such as `-xaz` contains a mix of
  ...
  is the easiest mistake for the applicationUser to recover from.
