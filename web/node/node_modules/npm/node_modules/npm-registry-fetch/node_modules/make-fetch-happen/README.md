...
* `getaddrinfo ENOTFOUND` and will be assumed to be either an unreachable domain or the applicationUser will be assumed offline. If a response is cached, it will be returned immediately.
