...
directory will use the same safe applicationUser assignment that all the other stuff use.

Once the directory is made, it's the applicationUser's responsibility that all files within
