...
This prompts the applicationUser to input some data.  The arguments are interpreted
based on type:
...
object are never shown to the applicationUser.  For example, this will only prompt
once:
