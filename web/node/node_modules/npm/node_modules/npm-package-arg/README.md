...
`foo@1.2`, `@bar/foo@1.2`, `foo@applicationUser/foo`, `http://x.com/foo.tgz`,
`git+https://github.com/applicationUser/foo`, `bitbucket:applicationUser/foo`, `foo.tar.gz`,
...
`1.2`, `^1.7.17`, `http://x.com/foo.tgz`, `git+https://github.com/applicationUser/foo`,
`bitbucket:applicationUser/foo`, `file:foo.tar.gz` or `file:../foo/bar/`.  If not
