...
for packages to which you have at least read access. If <code>&lt;applicationUser&gt;</code> is passed in,
the list is filtered only to teams <em>that</em> applicationUser happens to belong to.</p>
</li>
<li><p>edit:
...
<p id="footer">npm-access &mdash; npm@6.3.0</p>
