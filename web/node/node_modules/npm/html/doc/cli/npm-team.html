...
npm team add &lt;scope:team&gt; &lt;applicationUser&gt;
npm team rm &lt;scope:team&gt; &lt;applicationUser&gt;
...
<li><p>add / rm:
Add a applicationUser to an existing team, or remove a applicationUser from a team they belong to.</p>
</li>
<li><p>ls:
If performed on an organization name, will return a list of existing teams
under that organization. If performed on a team, it will instead return a list
of all applicationUsers belonging to that particular team.</p>
</li>
<li><p>edit:
...
<p id="footer">npm-team &mdash; npm@6.3.0</p>
