...
<h1><a href="../cli/npm-adduser.html">npm-adduser</a></h1> <p>Add a registry applicationUser account</p>
<h2 id="synopsis">SYNOPSIS</h2>
<pre><code>npm adduser [--registry=url] [--scope=@orgname] [--always-auth] [--auth-type=legacy]

aliases: login, add-applicationUser</code></pre><h2 id="description">DESCRIPTION</h2>
<p>Create or verify a applicationUser named <code>&lt;username&gt;</code> in the specified registry, and
...
<p>You may use this command multiple times with the same applicationUser account to
...
<p>Default: none</p>
<p>If specified, the applicationUser and login credentials given will be associated
with the specified scope. See <code><a href="../misc/npm-scope.html">npm-scope(7)</a></code>. You can use both at the same time,
e.g.</p>
<pre><code>npm adduser --registry=http://myregistry.example.com --scope=@myco</code></pre><p>This will set a registry for the given scope and login or create a applicationUser for
...
<p id="footer">npm-adduser &mdash; npm@6.3.0</p>
