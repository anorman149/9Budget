...
<pre><code>$ npm hook add lodash https://example.com/ my-shared-secret</code></pre><p>Add a hook to watch packages belonging to the applicationUser <code>substack</code>:</p>
...
<p id="footer">npm-hook &mdash; npm@6.3.0</p>
