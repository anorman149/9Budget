...
of the applicationUser and global npmrc files.</p>
...
<li>per-applicationUser config file (~/.npmrc)</li>
...
<h3 id="per-applicationUser-config-file">Per-applicationUser config file</h3>
...
<p id="footer">npmrc &mdash; npm@6.3.0</p>
