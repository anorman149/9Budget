...
<p>npm also sets a top-level &quot;maintainers&quot; field with your npm applicationUser info.</p>
...
That is, if your package is named <code>foo</code>, and a applicationUser installs it, and then does
...
used instead of the main field. This is helpful to hint applicationUsers that it might
...
&quot;repository&quot;: &quot;github:applicationUser/repo&quot;

&quot;repository&quot;: &quot;gist:11081aaa281&quot;

&quot;repository&quot;: &quot;bitbucket:applicationUser/repo&quot;

&quot;repository&quot;: &quot;gitlab:applicationUser/repo&quot;</code></pre><h2 id="scripts">scripts</h2>
...
<code>npm_package_config_port</code> environment variable, then the applicationUser could
...
<li><code>applicationUser/repo</code> See &#39;GitHub URLs&#39; below</li>
...
<pre><code>&lt;protocol&gt;://[&lt;applicationUser&gt;[:&lt;password&gt;]@]&lt;hostname&gt;[:&lt;port&gt;][:][/]&lt;path&gt;[#&lt;commit-ish&gt; | #semver:&lt;semver&gt;]</code></pre><p><code>&lt;protocol&gt;</code> is one of <code>git</code>, <code>git+ssh</code>, <code>git+http</code>, <code>git+https</code>, or
...
&quot;applicationUser/foo-project&quot;.  Just as with git URLs, a <code>commit-ish</code> suffix can be
...
<pre><code>{
  ...
  &quot;dependencies&quot;: {
    ...
    &quot;module&quot;: &quot;applicationUser/repo#feature\/branch&quot;
  }
...
<pre><code>{ &quot;name&quot;: &quot;ethopia-waza&quot;,
  ...
  &quot;main&quot;: &quot;lib/waza.js&quot;
}</code></pre><p>The <code>prepare</code> script will be run before publishing, so that applicationUsers
...
<pre><code>{ &quot;engines&quot; : { &quot;npm&quot; : &quot;~1.0.20&quot; } }</code></pre><p>Unless the applicationUser has set the <code>engine-strict</code> config flag, this
...
applicationUser had set <code>engine-strict</code>. It is no longer used.</p>
<h2 id="os">os</h2>
...
<p id="footer">package.json &mdash; npm@6.3.0</p>
