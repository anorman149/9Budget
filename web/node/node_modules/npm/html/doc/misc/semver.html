...
semantics.</p>
<p>Second, a applicationUser who has opted into using a prerelease version has
clearly indicated the intent to use <em>that specific</em> set of
alpha/beta/rc versions.  By including a prerelease tag in the range,
the applicationUser is indicating that they are aware of the risk.  However, it
...
<p id="footer">semver &mdash; npm@6.3.0</p>
