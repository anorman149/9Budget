...
<p>There sometimes arise cases where a applicationUser publishes a module, and then later,
some other applicationUser wants to use that name. Here are some common ways that happens
...
the package or applicationUser account on <a href="https://www.npmjs.com/">https://www.npmjs.com/</a>.
