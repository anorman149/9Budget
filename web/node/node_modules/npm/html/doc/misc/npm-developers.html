...
that your applicationUsers will do to install your program.</p>
...
<pre><code>git://github.com/applicationUser/project.git#commit-ish
git+ssh://applicationUser@hostname:project.git#commit-ish
git+http://applicationUser@hostname/project/blah.git#commit-ish
git+https://applicationUser@hostname/project/blah.git#commit-ish</code></pre><p>The <code>commit-ish</code> can be any tag, sha, or branch which can be supplied as
...
<h2 id="create-a-applicationUser-account">Create a User Account</h2>
<p>Create a applicationUser with the adduser command.  It works like this:</p>
...
<p id="footer">npm-developers &mdash; npm@6.3.0</p>
