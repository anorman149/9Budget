...
<p>There are three levels of org applicationUsers:</p>
<ol>
...
<p>The super admin is the only person who can add applicationUsers to the org because it impacts the monthly bill. The super admin will use the website to manage membership. Every org has a <code>developers</code> team that all applicationUsers are automatically added to.</p>
...
<pre><code>npm team add &lt;org:team&gt; &lt;applicationUser&gt;</code></pre><h2 id="publish-a-package-and-adjust-package-access">Publish a package and adjust package access</h2>
<ul>
...
<pre><code>npm access ls-packages &lt;org&gt; &lt;applicationUser&gt;</code></pre><ul>
...
<p id="footer">npm-orgs &mdash; npm@6.3.0</p>
