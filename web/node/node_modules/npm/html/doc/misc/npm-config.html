...
<li>per-applicationUser configuration file (defaults to <code>$HOME/.npmrc</code>; configurable via CLI
...
should be polled while the applicationUser is completing authentication.</p>
...
scripts.  If set explicitly to false, then installing as a non-root applicationUser
will fail.</p>
...
<p>The location of applicationUser-level configuration settings.</p>
...
<h3 id="applicationUser-agent">applicationUser-agent</h3>
<ul>
