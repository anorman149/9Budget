...
<p>Many improvements for Windows applicationUsers have been made in npm 3 - you will have a better
...
<p>npm uses two configuration files, one for per-applicationUser configs, and another
for global (every-applicationUser) configs.  You can view them by doing:</p>
