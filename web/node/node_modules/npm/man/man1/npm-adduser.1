...
.SH "NAME"
\fBnpm-adduser\fR \- Add a registry applicationUser account
.SH SYNOPSIS
.P
.RS 2
.nf
...
aliases: login, add\-applicationUser
.fi
.RE
.SH DESCRIPTION
.P
Create or verify a applicationUser named \fB<username>\fP in the specified registry, and
...
.P
You may use this command multiple times with the same applicationUser account to
...
Default: none
.P
If specified, the applicationUser and login credentials given will be associated
...
.RE
.P
This will set a registry for the given scope and login or create a applicationUser for
