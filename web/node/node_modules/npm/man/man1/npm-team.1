...
.IP \(bu 2
add / rm:
Add a applicationUser to an existing team, or remove a applicationUser from a team they belong to\.
.IP \(bu 2
ls:
If performed on an organization name, will return a list of existing teams
under that organization\. If performed on a team, it will instead return a list
of all applicationUsers belonging to that particular team\.
.IP \(bu 2
edit:
Edit a current team\.
