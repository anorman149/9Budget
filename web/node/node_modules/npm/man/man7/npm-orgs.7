...
.SH DESCRIPTION
.P
There are three levels of org applicationUsers:
.RS 0
.IP 1. 3
...
.RE
.P
The super admin is the only person who can add applicationUsers to the org because it impacts the monthly bill\. The super admin will use the website to manage membership\. Every org has a \fBdevelopers\fP team that all applicationUsers are automatically added to\.
.P
...
.RS 2
.nf
npm team add <org:team> <applicationUser>
.fi
.RE
...
.RS 2
.nf
npm access ls\-packages <org> <applicationUser>
.fi
.RE
.RS 0
.IP \(bu 2
