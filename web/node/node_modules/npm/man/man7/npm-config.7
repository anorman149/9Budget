...
.IP \(bu 2
per\-applicationUser configuration file (defaults to \fB$HOME/\.npmrc\fP; configurable via CLI
...
should be polled while the applicationUser is completing authentication\.
.SS sso\-type
.RS 0
.IP \(bu 2
Default: 'oauth'
...
.RE
.P
The location of applicationUser\-level configuration settings\.
.SS umask
.RS 0
.IP \(bu 2
Default: 022
