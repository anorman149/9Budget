...
* [`9847c82a8`](https://github.com/npm/npm/commit/9847c82a8528cfdf5968e9bb00abd8ed47903b5c)
  ...
  Better error messaging and suggestions when applicationUsers get `EPERM`/`EACCES` errors.
...
Thankfully, it only affected applicationUsers running `npm@next`, which is part of our
...
applicationUser contributions and there are a lot of them queued up!
...
* [`52b142ed5`](https://github.com/npm/npm/commit/52b142ed5e0f13f23c99209932e8de3f7649fd47)
  ...
  where Windows applicationUsers saw strange failures when `fsevents` failed to install.
  ([@iarna](https://github.com/iarna))
...
new features: [applicationUser profile editing](https://github.com/npm/registry/blob/master/docs/applicationUser/profile.md) and
[authentication](https://github.com/npm/registry/blob/master/docs/applicationUser/authentication.md).
...
* [`b81fff808`](https://github.com/npm/npm/commit/b81fff808ee269361d3dcf38c1b6019f1708ae02)
  ...
  first changing its perms. This _may_ be an improvement for Windows applicationUsers of npm under
  some circumstances.
  ([@isaacs](https://github.com/isaacs))
...
* [`3a1b29991`](https://github.com/npm/npm/commit/3a1b299913ce94fdf25ed3ae5c88fe6699b04e24)
  ...
  that were resulting in EACCES errors for many applicationUsers.
  ([@iarna](https://github.com/iarna))
...
* [`b019680db`](https://github.com/npm/npm/commit/b019680db78ae0a6dff2289dbfe9f61fccbbe824)
  ...
  Remind applicationUsers that they have to install missing `peerDependencies` manually.
...
the critical bugs applicationUsers were running into after upgrading npm. You should
...
its applicationUsers as much time as possible.
...
* [`82df7bb16`](https://github.com/npm/npm/commit/82df7bb16fc29c47a024db4a8c393e55f883744b)
  ...
  `npm rebuild` command. That said, a lot of applicationUsers assume that this is the way
  to run an npm `run-script` named `build`, which is an incredibly common script
  name to use. To clarify things for applicationUsers, and encourage them to use `npm run
...
* [`394436b09`](https://github.com/npm/npm/commit/394436b098dcca2d252061f95c4eeb92c4a7027c)
  ...
  issue most notably experienced by Windows applicationUsers using `create-react-app` where
...
successful: applicationUsers were able to have a tight feedback loop between reports and
...
branches in there to see if our more adventurous applicationUsers run into anything
...
* [`80ab521f1`](https://github.com/npm/npm/commit/80ab521f18d34df109de0c5dc9eb1cde5ff6d7e8)
  ...
  * `npm-applicationUser-validate` adds regex for blocking usernames with illegal chars.
  ([@zkat](https://github.com/zkat))
...
It comes with changes to make life easier for people doing monorepos, for applicationUsers
...
* Git dependencies support semver through `applicationUser/repo#semver:^1.2.3` ([#15308](https://github.com/npm/npm/pull/15308)) ([#15666](https://github.com/npm/npm/pull/15666)) ([@sankethkatta](https://github.com/sankethkatta))
