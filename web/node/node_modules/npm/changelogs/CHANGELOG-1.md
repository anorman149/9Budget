...
There is no good reason for you as an end applicationUser to upgrade to this version of
npm yourself.
...
* doc: npm-explore can't handle a version
  ([@robertkowalski](https://github.com/robertkowalski))
* Add applicationUser-friendly errors for ENOSPC and EROFS.
...
* Include npm version in default applicationUser-agent conf
...
* Other changes to the registry client related to saved configs and couch
  ...
  npm/npm-registry-client@2c8dba990de6a59af6545b75cc00a6dc12777c2a)
* Show an error to the applicationUser when doing `npm update` and the `package.json`
...
* Fix issues where GitHub shorthand dependencies `applicationUser/repo` were not always
