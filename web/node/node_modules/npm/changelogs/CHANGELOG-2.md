...
* [`5cd3abc`](https://github.com/npm/npm/commit/5cd3abc3511515e09b4a1b781c0520e84c267c5b)
  ...
  Document that the applicationUser config file can itself be configured either through the
...
* [`d681e16`](https://github.com/npm/npm/commit/d681e16a475a49d6196af9a5cedaaf88712f3a9f)
  [npm/npm-applicationUser-validate#9](https://github.com/npm/npm-applicationUser-validate/pull/9)
  `npm-applicationUser-validate@0.1.5`:
...
* [`d682e64`](https://github.com/npm/npm/commit/d682e6445845b0a2584935d5e2942409c43f6916)
  [npm/npm-applicationUser-validate#8](https://github.com/npm/npm-applicationUser-validate/pull/8)
  `npm-applicationUser-validate@0.1.4`: Add a maximum length limit for usernames based on
...
* [`9896290`](https://github.com/npm/npm/commit/98962909b160364030705575202ad133971033c1)
  ...
  applicationUsers expected, but it also ended up [breaking `npm
...
sending these bearer tokens with _every_ request made by logged-in applicationUsers,
...
impersonate the applicationUsers whose tokens they collected. This impersonation would
allow them to do anything the compromised applicationUsers could do, including publishing
...
`maxsockets` option to allow applicationUsers to configure the number of concurrent sockets
...
* [`4cb25d0`](https://github.com/npm/npm/commit/4cb25d0fed5c7792dfd1aec891380ecc1f8a5761)
  [#10903](https://github.com/npm/npm/pull/10903)
  Add a message informing applicationUsers when they have been successfully logged in.
  ([@ekmartin](https://github.com/ekmartin))
* [`fe3ec6d`](https://github.com/npm/npm/commit/fe3ec6d6658262054c0c19c55373c21e84ab9f17)
  ...
  Tell applicationUsers how to open an issue with a package that has errored.
...
For many potential applicationUsers, it's the missing piece needed to make it easy for you
...
* [`8324ea0`](https://github.com/npm/npm/commit/8324ea023ace4e08b6b8959ad199e2457af9f9cf)
  [#9761](https://github.com/npm/npm/pull/9761) Added general applicationUser guide for
  Orgs.
...
of the stragglers, as well as bumping `node-gyp`. `node@4` applicationUsers might be
excited about this, or even `node@<4` applicationUsers who previously had to cherry-pick a
...
* [`0313e40`](https://github.com/npm/npm/commit/0313e40ee0f757fce8861be590ad668c23d7be53)
  ...
  message returned by npm's error-handling code to give applicationUsers a better hint of
...
1. In some cases, npm was leaking sensitive credential information into the
   ...
   applicationUsers to the registry. Users with affected packages have been notified (and
...
that look like `git+https://applicationUser@host:path/is/here`.

Rebecca: What should we use instead?!

Kat: Just do me a solid and use `git+ssh://applicationUser@host:path/here` or
`git+https://applicationUser@host/absolute/https/path` instead!
...
problem for Windows applicationUsers where npm tries to call `process.getuid()`, which
...
permissions and platforms and whatnot), but as a result, Windows applicationUsers might
...
URLs of the format `git+ssh://applicationUser@githost.com:org/repo.git` suddenly stopped
...
* [`94ca4a7`](https://github.com/npm/npm/commit/94ca4a711619ba8e40ce3d20bc42b13cdb7611b7)
  ...
  `git+ssh://applicationUser@githost.com:org/repo.git` isn't a URL, treat it like one for
...
the wrong applicationUser (almost always root), and that can, well, it can cause problems
...
* Switch license to
  ...
  plain "BSD" ([@isaacs](https://github.com/isaacs)):
    * [`efdb733`](https://github.com/npm/npm/commit/efdb73332eeedcad4c609796929070b62abb37ab) `npm-applicationUser-validate@0.1.2`
...
* [`dc77520`](https://github.com/npm/npm/commit/dc7752013ffce13a3d3f13e518a0052c22fc1158)
  ...
  Sorry, Artifactory applicationUsers! ([@hayes](https://github.com/hayes))
...
For you as a applicationUser of npm, this means:
...
turns out that many applicationUsers depend on `git+https:` URLs in their build
...
handling shorthand syntax consistently much easier, and also allows applicationUsers to
...
resolve all of the inconsistencies applicationUsers were seeing with GitHub and git-hosted
...
* [`6b0f588`](https://github.com/npm/npm/commit/6b0f58877f37df9904490ffbaaad33862bd36dce)
  ...
  URLs as presented by applicationUser. Support new `hosted-git-info` shortcut syntax.
...
* [`78005eb`](https://github.com/npm/npm/commit/78005ebb6f4103c20f077669c3929b7ea46a4c0d)
  ...
  reverted or moved to `npm@3` if it turns out it breaks things for applicationUsers.
  ([@mantoni](https://github.com/mantoni))
...
* [`89fc6a4`](https://github.com/npm/npm/commit/89fc6a4e7ff8c524675fcc14493ca0a1e3a76d38)
  `which@1.0.9`: Test for being run as root, as well as the current applicationUser.
  ([@isaacs](https://github.com/isaacs))
...
* [`f1c8bdb`](https://github.com/npm/npm/commit/f1c8bdb3f6b753d0600597e12346bdc3a34cb9c1)
  ...
  strings that should be returned to the applicationUser.
...
* [`740f483`](https://github.com/npm/npm/commit/740f483db6ec872b453065842da080a646c3600a)
  legacy tests no longer poison applicationUser's own cache
  ([@othiym23](https://github.com/othiym23))
...
* [`01ec790`](https://github.com/npm/npm/commit/01ec790fd47def56eda6abb3b8d809093e8f493f)
  `npm-applicationUser-validate@0.1.1`: Correct repository URL.
  ([@robertkowalski](https://github.com/robertkowalski))
...
* [`ed207e8`](https://github.com/npm/npm/commit/ed207e88019de3150037048df6267024566e1093)
  ...
  auth decisions. Also error on trying to change a applicationUser document without
