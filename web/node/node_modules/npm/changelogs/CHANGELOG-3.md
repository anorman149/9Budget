...
also got fixed at around the same time, mostly affecting Windows applicationUsers.
...
* [`ea018b9`](https://github.com/npm/npm/commit/ea018b9e3856d1798d199ae3ebce4ed07eea511b)
  [#13023](https://github.com/npm/npm/pull/13023)
  If a applicationUser were to have SUDO_UID and SUDO_GID, they'd be able to get into a
...
were biting applicationUsers. The code around that stuff got more readable/maintainable in
the process, too!
...
If you are a Linux applicationUser, it's plausible that this might have a performance
...
* [`4533bd5`](https://github.com/npm/npm/commit/4533bd501d54aeedfec3884f4fd54e8c2edd6020)
  `npm-applicationUser-validate@0.1.4`:
...
* [`b5a0fbb`](https://github.com/npm/npm/commit/b5a0fbb9e1a2c4fb003dd748264571aa6e3c9e70)
  ...
  Fix progress config testing to ignore local applicationUser configs.
...
* [`7aaf47e`](https://github.com/npm/npm/commit/7aaf47e124c45dde72c961638b770ee535fb2776)
  ...
  Update the README to suggest npm@3 for Windows applicationUsers. Also add a reference to
...
be really good news for our Windows applicationUsers once it rolls around. We're keeping an
...
* [`f8fb4d8`](https://github.com/npm/npm/commit/f8fb4d83923810eb78d075bd200a9376c64c3e3a)
  ...
  This is probably what most applicationUsers expected, but it also ended up [breaking `npm
...
* [`0d4a0b1`](https://github.com/npm/npm/commit/0d4a0b1)
  ...
  Fail if the applicationUser asks us to make a link from a module back on to itself.
...
This week brings a quality of life improvement for some Windows applicationUsers, and
...
* [`93cdc25`](https://github.com/npm/npm/commit/93cdc25432b71cbc9c25c54ae316770e18f4b01e)
  `strip-ansi@3.0.1`:
  Non-applicationUser visible tests & maintainer doc updates.
...
This isn't applicationUser visible, but in future should mean a more stable, easier to
...
This doesn't impact you as a applicationUser of npm, and ordinarily that means we
...
* [`b25efc8`](https://github.com/npm/npm/commit/b25efc88067c843ffdda86ea0f50f95d136a638e)
  [#9948](https://github.com/npm/npm/issues/9948) Encourage applicationUsers to file an
...
* [`180263b`](https://github.com/npm/npm/commit/180263b)
  ...
  requested by the applicationUser will trigger the error message.
  ([@iarna](https://github.com/iarna))
...
applicationUsers. Look for those next week.  As it happens, the dependencies updated
...
our applicationUsers.  We also have some tantalizing clues as to where some low hanging
...
upgrades, so they should not have visible impact on applicationUsers.
...
forward to working with the npm applicationUser community to get it production-ready
...
get applicationUsers out of the dependency hell caused by conflicting `peerDependency`
...
* [#6931](https://github.com/npm/npm/issues/6931) The rarely-used
  ...
  warnings. If you, as a applicationUser, want strict `engines` field enforcement,
...
* [#3697](https://github.com/npm/npm/issues/3697)
  This will hopefully eliminate most cases where Windows applicationUsers ended up
