...
* ls-collaborators:
  ...
  for packages to which you have at least read access. If `<applicationUser>` is passed in,
  the list is filtered only to teams _that_ applicationUser happens to belong to.
